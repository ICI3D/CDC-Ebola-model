...
defaults <- list(
  ...
  inc_pdf_ref = list(
    ...
    eichner = c(0.0000, 0.0000, 0.0000, 0.0000, 0.0036, 0.0144, 0.0302, 0.0604, 0.0904, 0.1000, 0.1034, 0.0966, 0.0958, 0.0868, 0.0686, 0.0538, 0.0470, 0.0422, 0.0266, 0.0210, 0.0165, 0.0167, 0.0105, 0.0083, 0.0073),
    legrand = c(0.0036, 0.0570, 0.1338, 0.1510, 0.1320, 0.1162, 0.0942, 0.0684, 0.0552, 0.0420, 0.0374, 0.0240, 0.0180, 0.0138, 0.0102, 0.0102, 0.0060, 0.0048, 0.0032, 0.0038, 0.0024, 0.0034, 0.0032, 0.0030, 0.0030)
  )
)
